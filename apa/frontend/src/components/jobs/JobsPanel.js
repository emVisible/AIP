...
export function JobsPanel() {
    ...
    return (_jsxs(Card, { children: [_jsxs("div", { className: "flex items-center justify-between px-3 py-2\n                      border-b border-slate-100", children: [_jsxs("span", { className: "flex items-center gap-1.5 text-xs font-semibold\n                         text-slate-700", children: [_jsx(Clock, { size: 13 }), " \u5B9A\u65F6\u4EFB\u52A1 (", jobs.length, ")"] }), _jsxs(Button, { size: "sm", variant: "secondary", onClick: () => setEditing({ id: "", kind: "cron", process: "",
                            expr: "0 * * * *", event: "" }), children: [_jsx(Plus, { size: 13 }), " \u65B0\u5EFA"] })] }), _jsxs("div", { className: "divide-y divide-slate-50", children: [jobs.map(j => (_jsxs("div", { className: "flex items-center gap-2 px-3 py-2\n                                     hover:bg-slate-50/60", children: [_jsx(Badge, { tone: j.kind === "cron" ? "blue"
                                    : j.kind === "watch" ? "amber" : "violet", children: j.kind }), _jsx("span", { className: "font-mono text-xs text-slate-700", children: j.id }), _jsx("span", { className: "font-mono text-[10px] text-slate-400 truncate", children: j.kind === "cron" ? j.expr : j.event }), !j.exists && _jsx(Badge, { tone: "red", children: "\u6D41\u7A0B\u7F3A\u5931" }), _jsxs("span", { className: "ml-auto text-[10px] text-slate-400", children: [j.next_run ? `下次 ${j.next_run}` : "", j.next_error ? "cron 无效" : ""] }), _jsx(IconButton, { label: "\u7ACB\u5373\u8FD0\u884C", onClick: () => void runNow(j.id), children: _jsx(Play, { size: 12 }) }), _jsx(IconButton, { label: "\u7F16\u8F91", onClick: () => setEditing({
                                    ...
                                    expr: j.expr ?? "0 * * * *", event: j.event ?? ""
                                            ...
                                            kind: e.target.value }), children: [_jsx("option", { value: "cron", children: "\u5B9A\u65F6 (cron)" }), _jsx("option", { value: "event", children: "\u4E8B\u4EF6" }), _jsx("option", { value: "watch", children: "\u6587\u4EF6\u76D1\u542C" })] }) }), editing.kind === "watch" ? (_jsx(Field, { label: "\u76D1\u542C\u8DEF\u5F84 (glob)", hint: "\u76F8\u5BF9\u5F53\u524D\u76EE\u5F55", children: _jsx(Input, { value: editing.expr, className: "font-mono", placeholder: "data/inbox/*.csv", onChange: e => setEditing({ ...editing,
                                            expr: e.target.value }) }) })) : editing.kind === "cron" ? (_jsx(Field, { label: "Cron \u8868\u8FBE\u5F0F", hint: "\u5206 \u65F6 \u65E5 \u6708 \u5468", children: _jsx(Input, { value: editing.expr, className: "font-mono", placeholder: "0 9 * * *", onChange: e => setEditing({ ...editing,
